...
class Camera(object):
    ...
    def update(self, player, level, screen):
        self.level_offset.x( (screen.get_width() - player.width()) / 2 - self.player_offset.x() - player.x())
        self.level_offset.y( (screen.get_height() - player.height()) / 2 - self.player_offset.y() - player.y())
